...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2025 a las 02:14:09
...
(1, '2025-05-25 22:34:49', 131.6, 25, 156.6, 'Nequi', 1, 1),
(2, '2025-05-25 22:36:08', 18.8, 3.57, 22.37, 'Nequi', 1, 1),
(3, '2025-05-25 22:39:28', 18.8, 3.57, 22.37, 'Nequi', 1, 1),
(4, '2025-05-25 22:40:21', 18.8, 3.57, 22.37, 'Nequi', 18, 1),
(5, '2025-05-25 22:43:00', 19, 3.61, 22.61, 'Nequi', 1, 1),
(6, '2025-05-25 22:43:17', 18.8, 3.57, 22.37, 'Nequi', 1, 1),
(7, '2025-05-25 22:48:33', 18.8, 3.57, 22.37, 'Nequi', 1, 1),
(8, '2025-05-25 22:54:08', 18.8, 3.57, 22.37, 'Nequi', 1, 1);
...
(1, 'Diego_el_perron', 'Elperron', 'diegoelperron@gmail.com', 'pbkdf2:sha256:260000$frJhcEzwM97jb3os$c5cf357d5ff88d9763d316d528531ead5a1b33261f2dc91863bd77cd47524e49', 'ADMIN', '2025-05-25', 'Dirección del Superadmin', '1234567890', NULL),
(2, 'David_21', 'Gansta_Life', 'davinci21@gmail.com', 'pbkdf2:sha256:260000$kOiGpPYpG96JICV1$0ae6586db1ce1b9988981dd03d213e0e75f6c2049c9b6dda5d2a7d020c8bf489', 'ADMIN', '2025-05-25', 'Dirección del Superadmin002', '3008353399', NULL);
...
ALTER TABLE `juego`
  ...
  ADD CONSTRAINT `juego_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuario` (`id`);
